...
import { View, Text, ScrollView, StatusBar, StyleSheet, Alert, BackHandler } from 'react-native';
...
export const ResumenReser = ({ navigation }) => {
    ...
    const validatePrecio = () => {
        try {
            ...
            console.log("COMPARTIDO: ", registerForm)
            console.log("PRIVADO: ", registerPriv)
    ...
    const saveReservation = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (updateBoleto) {
                    if (updateBoleto.tipoBoleto == "compartido" || updateBoleto.tipoBoleto == "Privado") {
                        navigation.reset({
                            index: 0,
                    ...
                    navigation.reset({
                        index: 0,
                        routes: [{ name: ROUTES.HOME_CUSTUMER }],
                    });
                }
